...
- v4.4 2024
	- 整体修改思路是让所有技能都有一定吸引力，适度提升早期的战斗力，弥补部分中前期的致命缺陷
	- 技能改动：
	  *	添加3种物理拳法，避免铁砧环境里只有1级火拳有用其它拳法毫无用处的窘境
	  *	调整2 3 4级心法的数值，更其配得上高级技能
	  *	调整混元乱舞的持续时间，增大其它高阶技能的吸引力
	  *	调整裂空掌的数值，此前每点期望收益不到1点伤害。去掉裂空掌的最大伤害，增大惊喜
